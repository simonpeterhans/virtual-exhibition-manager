...
public interface ActionHandler<A> extends Route {
    ...
    /**
     * This method gets invoked by the router after a GET request has been processed. It parameters and does something meaningful with it. Once processing has completed, the method returns a resulting object.
     *
    ...
    /**
     * This method gets invoked by the router after a DELETE request has been processed. It takes parameters and does something meaningful with it. Once processing has completed, the method returns a resulting object or null.
     *
     * @param parameters Map containing named parameters in the URL.
     * @throws ActionHandlerException If an error occurs during invocation.
     */
    ...
    /**
     * This method gets invoked by the router after a POST request has been processed. It takes an optional context object and parameters and does something meaningful with it. Once processing has completed, the method returns a resulting object.
     *
