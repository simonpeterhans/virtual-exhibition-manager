...
@Cli(name = "VREM", description = "Virtual Reality Exhibition Manager", commands = {WebServer.class, DemoImporter.class, ExhibitionImporter.class, Help.class}, defaultCommand = Help.class)
public class VREM {
