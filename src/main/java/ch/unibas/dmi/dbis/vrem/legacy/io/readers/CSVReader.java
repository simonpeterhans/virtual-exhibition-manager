package ch.unibas.dmi.dbis.vrem.legacy.io.readers;

import ch.unibas.dmi.dbis.vrem.legacy.io.AbstractCSV;
        ...
        do {
            ...
            for (int i = 0; i < nextLine.length(); i++) {
                ...
                if (this.quote != null && this.quote.equals(c)) {
                    if (inQuotes && nextLine.length() > (i + 1) && quote.equals(nextLine.charAt(i + 1))) {
