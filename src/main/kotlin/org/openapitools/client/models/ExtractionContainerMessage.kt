...
data class ExtractionContainerMessage(
    @Json(name = "items")
    val items: kotlin.collections.List<ExtractionItemContainer>? = null,
    @Json(name = "messageType")
    val messageType: ExtractionContainerMessage.MessageType? = null
) {
