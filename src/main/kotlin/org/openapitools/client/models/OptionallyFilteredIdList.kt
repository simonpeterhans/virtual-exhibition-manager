...
data class OptionallyFilteredIdList(
    @Json(name = "filters")
    val filters: kotlin.collections.List<AbstractMetadataFilterDescriptor>? = null,
    @Json(name = "ids")
    val ids: kotlin.collections.List<kotlin.String>? = null,
    @Json(name = "messageType")
    val messageType: OptionallyFilteredIdList.MessageType? = null,
    @Json(name = "idList")
    val idList: kotlin.collections.List<kotlin.String>? = null
) {
