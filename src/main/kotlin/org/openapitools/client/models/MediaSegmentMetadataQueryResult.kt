...
data class MediaSegmentMetadataQueryResult(
    @Json(name = "content")
    val content: kotlin.collections.List<MediaSegmentMetadataDescriptor>? = null,
    @Json(name = "queryId")
    val queryId: kotlin.String? = null,
    @Json(name = "messageType")
    val messageType: MediaSegmentMetadataQueryResult.MessageType? = null
) {
