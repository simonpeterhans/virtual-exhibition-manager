...
data class MediaObjectMetadataQueryResult(
    @Json(name = "content")
    val content: kotlin.collections.List<MediaObjectMetadataDescriptor>? = null,
    @Json(name = "queryId")
    val queryId: kotlin.String? = null,
    @Json(name = "messageType")
    val messageType: MediaObjectMetadataQueryResult.MessageType? = null
) {
