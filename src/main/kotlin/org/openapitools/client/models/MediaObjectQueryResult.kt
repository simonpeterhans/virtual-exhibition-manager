...
data class MediaObjectQueryResult(
    @Json(name = "content")
    val content: kotlin.collections.List<MediaObjectDescriptor>? = null,
    @Json(name = "queryId")
    val queryId: kotlin.String? = null,
    @Json(name = "messageType")
    val messageType: MediaObjectQueryResult.MessageType? = null
) {
